...
public class KeepLastElementPriorToLowerBoundStrategyTest {
	...
	public void setUp() throws Exception {
		...
		this.expectedMeasurement = new TupleMeasurement(metricDescription, Measure.valueOf(4.75, SI.SECOND),  Measure.valueOf(42L, Unit.ONE));
	}
	...
	private void initiallyFillWindowWithMeasurements() {
		...
		//the last 6 of which should be in window after a move on (increment 5s): (4.75s, 42), ... , (9.75s, 42)
	}
	...
	private void mockMoveOn() {
		this.currentLowerBound = Measure.valueOf(
				this.currentLowerBound.getValue() + this.increment.getValue(),
				SI.SECOND);
