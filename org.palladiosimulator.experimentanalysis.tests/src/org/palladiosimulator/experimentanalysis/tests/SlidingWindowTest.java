...
public abstract class SlidingWindowTest {
    ...
    //the measurements are tuples, that is, window has to extract the state measurements from the tuple measurement
    ...
    public void setUp() throws Exception {
        ...
        this.measurement = new TupleMeasurement(measurementsMetricDescription, this.pointInTimeMeasure, this.stateMeasure);
