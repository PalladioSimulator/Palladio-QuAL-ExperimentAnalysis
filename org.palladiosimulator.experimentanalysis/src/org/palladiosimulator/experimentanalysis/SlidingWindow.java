...
public abstract class SlidingWindow extends AbstractObservable<ISlidingWindowListener> {
     ...
     * the collected data (i.e., the measurements) are adjusted when the window moves forward. For
    ...
    public interface ISlidingWindowMoveOnStrategy {
        /**
         * This method specifies how the collected data (i.e., the measurements) are adjusted when
         * the window moves forward. It is called by the associated {@link SlidingWindow} instance
         * each time it has moved forward.<br>
         ...
         *            at the moment it moved forward. The adjustment of the data has to be done
         *            in-place, i.e., this Deque has to be manipulated directly.
         * @param newLowerBound
