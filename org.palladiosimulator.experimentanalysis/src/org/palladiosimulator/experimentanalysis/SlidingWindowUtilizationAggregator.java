...
public class SlidingWindowUtilizationAggregator extends SlidingWindowAggregator {
     ...
     * @return A {@link Measurement} denoting the utilization {@code U} which is calculated as follows: {@code U = busyTime / windowLength}.
     */
     ...
     * @param measurement A ({@code not null}) {@link Measurement} instance containing a {@code point in time} measure.
     * @return An {@link Amount} that represents the {@code point in time} the given measurement was taken.
     */
    private static Amount<Duration> obtainPointInTimeAmountFromMeasurement(Measurement measurement) {
     ...
     * @param measurement A ({@code not null}) {@link Measurement} instance containing a {@code state of active resource} measure.
     * @return A <b>nonnegative</b> long denoting the {@code state of active resource} value.
     */
    private static long obtainStateValueFromMeasurement(Measurement measurement) {
