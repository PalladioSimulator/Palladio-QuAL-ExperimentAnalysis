...
public class SlidingWindowRecorder extends AbstractRecorder {
    ...
    /**
     * Initializes a new instance of the {@link SlidingWindowRecorder} class with the given
     * parameters.
     * 
     * @param slidingWindow
     ...
     *            {@link SlidingWindowAggregator}s, that will be attached to the given window (
     *            {@code null} is okay).
     * 
     ...
     *            {@link SlidingWindow} to write incoming measurements into.
     * @param listener
     *            A {@link ISlidingWindowListener}, typically a {@link SlidingWindowAggregator},
     *            that will be attached to the given window.
     * 
     * @throws IllegalArgumentException
     *             If the given window is {@code null}.
     */
    ...
    /**
     * {@inheritDoc}<br>
     * That is, the given measurement is written into the associated {@link SlidingWindow}.
     * 
     * @throws IllegalArgumentException
     *             If the given measurement is {@code null} or does not adhere to the metric the
     *             associated window accepts.
    ...
    /**
     * {@inheritDoc}<br>
     * It has the corresponding {@link SlidingWindow} instance discard the collected data.
     */
    @Override
    public void flush() {
